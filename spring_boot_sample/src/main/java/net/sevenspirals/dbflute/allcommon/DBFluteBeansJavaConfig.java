package net.sevenspirals.dbflute.allcommon;
...
import net.sevenspirals.dbflute.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="net.sevenspirals.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new net.sevenspirals.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new net.sevenspirals.dbflute.allcommon.ImplementedInvokerAssistant();
    }
