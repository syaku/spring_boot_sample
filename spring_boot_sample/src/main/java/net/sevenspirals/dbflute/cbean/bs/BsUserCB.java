package net.sevenspirals.dbflute.cbean.bs;
...
import net.sevenspirals.dbflute.allcommon.DBFluteConfig;
import net.sevenspirals.dbflute.allcommon.DBMetaInstanceHandler;
import net.sevenspirals.dbflute.allcommon.ImplementedInvokerAssistant;
import net.sevenspirals.dbflute.allcommon.ImplementedSqlClauseCreator;
...
public class BsUserCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public UserCB acceptUniqueOf(String eMail) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<UserCQ> {
         ...
         * <pre>
         * cb.specify().<span style="color: #CC4747">derived${relationMethodIdentityName}()</span>.<span style="color: #CC4747">max</span>(tweetCB <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
         *     tweetCB.specify().<span style="color: #CC4747">column...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *     tweetCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, Tweet.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TweetCB, UserCQ> derivedTweet() {
            assertDerived("tweetList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<TweetCB> sq, UserCQ cq, String al, DerivedReferrerOption op)
